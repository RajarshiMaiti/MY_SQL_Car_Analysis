...
-- Client asked me to print the total of all cards by tear. I don't see all the details.--
select year, count(*) from car_dekho group by year;

-- Client asked to car delaer agent how many diesel cars will be there in 2020? --
...
-- The Manager said to the employee All cars details between 2015 to 2023 we neeed complete list --
